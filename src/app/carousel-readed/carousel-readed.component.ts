...
@Component({
  selector: 'app-carousel-readed',
  templateUrl: './carousel-readed.component.html',
  styleUrls: ['./carousel-readed.component.css']
})
export class CarouselReadedComponent implements OnInit {
